    ...
    const {url} = body
     ...
     if (!url) {
      ...
      try{
          ...
          const metadata = await metascraper({ html: body, url: link })
          ...
          if(metadata){
            ...
            // `
            card = `
            <a href="${link}" target="_blank" class="headline link-box no-underline">
            <div class="w-full lg:max-w-full lg:flex mb-8 link-embed-box">
            ...
            <div class="border-r border-b border-l border-gray-200 h-48 lg:border-l-0 lg:border-t bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              <div class="my-auto">
