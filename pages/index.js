...
const PrototyprNetworkCTA = ({ data }) => {
  return (
    <div className="flex flex-col grid gap-1 justify-end items-end">
      <div className="w-full rounded-[12px] h-auto bg-[#fff] p-6 grid flex flex-col grid gap-3 ">
          ...
          <div className="w-full flex flex-col grid gap-2">
            ...
            {type === "jobs" && (
              <div className="flex rounded-lg flex-col gap-0 p-4">
                ...
                >
                  <div className="text-xs inline-flex"><div className="mr-1">Hiring? Post a Job</div><div>{"->"}</div></div>
                </a>
              </div>
            )}
          </div>
