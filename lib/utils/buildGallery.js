const buildToolboxGallery = ({ item, PHOTO_SET, featuredImage }) => {
  ...
  if (!PHOTO_SET.length) {
    PHOTO_SET.push({
      thumbnail:
      featuredImage?featuredImage:"https://prototypr.gumlet.com/https://prototypr-media.sfo2.digitaloceanspaces.com/uploads/2021/04/Screen-Shot-2021-04-30-at-4.37.37-PM.png",
      original:
      featuredImage?featuredImage: "https://prototypr.gumlet.com/https://prototypr-media.sfo2.digitaloceanspaces.com/uploads/2021/04/Screen-Shot-2021-04-30-at-4.37.37-PM.png",
      originalAlt: "Screenshot of product",
      thumbnailAlt: "Smaller procut screenshot thumbnail",
