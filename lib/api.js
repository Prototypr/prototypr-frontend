...
export async function getCombinedPostsForHome(preview) {
  const data = await fetchAPI(
    newHomeQuery,
    {
      // variables: {
...
export async function getAllPostsForPostsPage(preview, limit, start) {
  const data = await fetchAPI(
    postsQuery,
    {
      variables: {
...
export async function getPostsByPageForPostsPage(preview, pageSize, page) {
  const data = await fetchAPI(
    postsPageQuery,
    {
      variables: {
