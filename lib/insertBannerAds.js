...
const insertBannerAds = (htmlString, navSponsor, sponsors) => {
  ...
  <div class="my-10">
    ...
    <div class="bg-white  h-full p-0 border border-gray-300/50 shadow-sm overflow-hidden group hover:shadow-lg hover:scale-[1.005] transition transition-all duration-300 rounded-2xl flex flex-col sm:flex-row   w-full ">
