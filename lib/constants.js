import {Robot, Swatches, HandEye, Wheelchair, FlowArrow,BoundingBox,GitBranch} from '@/components/icons'
const PAGE_SIZE = 12;
...
export const TOTAL_STATIC_POSTS = process.env.NODE_ENV === 'production'?20:2;
export const TOTAL_STATIC_NEWSLETTERS = process.env.NODE_ENV === 'production'?20:2;
export const TOTAL_STATIC_NEWS = process.env.NODE_ENV === 'production'?20:2;
