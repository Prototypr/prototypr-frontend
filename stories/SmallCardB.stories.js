import SmallCardB from "../components/v4/card/SmallCard/SmallCardB";

export default {
  title: "Components/Card/Small Card B",
  component: SmallCardB,
  argTypes: {
    image: {
...
const Template = (args) => <SmallCardB {...args} />;
export const Small = Template.bind({});
Small.storyName = "SmallCardB";
Small.args = {
