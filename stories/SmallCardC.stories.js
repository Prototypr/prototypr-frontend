import SmallCardC from "../components/v4/card/SmallCard/SmallCardC";

export default {
  title: "Components/Card/Small Card C",
  component: SmallCardC,
  argTypes: {
    image: {
...
const Template = (args) => <SmallCardC {...args} />;
export const Small = Template.bind({});
Small.storyName = "SmallCardC";
Small.args = {
