    ...
    <div className="flex w-full flex-row flex-wrap md:flex-col text-gray-900 md:mb-6 ">
      ...
      <Link href="/account" className="mb-2">
        <div className={"text-gray-700 "}>
          <div
            className={`${activeTab == 1 ? "bg-blue-100 font-semibold text-black/90 text-black/90" : "hover:bg-blue-100/80"} flex justify-start p-3 rounded-xl text-md cursor-pointer w-full`}
          >
            <div className="flex justify-start">
              ...
              <User size={22} className="mr-2 my-auto" />
              <div className="my-auto text-center mx-auto text-md">General</div>
            </div>
          </div>
        </div>
      </Link>
      <Link href="/account/topics" className="mb-2">
        <div className={"text-gray-700"}>
          <div
            className={`${activeTab == 2 ? "bg-blue-100 font-semibold text-black/90 text-black/90" : "hover:bg-blue-100/80"} flex justify-start p-3 rounded-xl text-md cursor-pointer w-full`}
          >
            <div className="flex justify-start">
              ...
              <FolderPlus size={22} className="mr-2 my-auto" />
              <div className="my-auto text-center text-md">Topics</div>
            </div>
          </div>
        </div>
      </Link>
      <Link href="/account/interests" className="mb-2">
        <div className={"text-gray-700"}>
          <div
            className={`${activeTab == 3 ? "bg-blue-100 font-semibold text-black/90 text-black/90" : "hover:bg-blue-100/80"} flex justify-start p-3 rounded-xl text-md cursor-pointer w-full`}
          >
            <div className="flex justify-start">
              {/* <svg className="w-4 h-4 mr-3 my-auto"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M20 22H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1zm-1-2V4H5v16h14zM8 9h8v2H8V9zm0 4h8v2H8v-2z" fill="currentColor"/></svg> */}
              <ListChecks size={22} className="mr-2 my-auto" />
              <div className="my-auto text-center text-md">Interests</div>
            </div>
          </div>
        </div>
      </Link>
      <Link href="/account/newsletters" className="mb-2">
        <div className={"text-gray-700"}>
          <div
            className={`${activeTab == 4 ? "bg-blue-100 font-semibold text-black/90 text-black/90" : "hover:bg-blue-100/80"} flex justify-start p-3 rounded-xl text-md cursor-pointer w-full`}
          >
            <div className="flex justify-start">
              <Envelope size={22} className="mr-2 my-auto" />
              {/* <svg className="w-4 h-4 mr-3 my-auto"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M20 22H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1zm-1-2V4H5v16h14zM8 9h8v2H8V9zm0 4h8v2H8v-2z" fill="currentColor"/></svg> */}
              <div className="my-auto text-center text-md">Newsletters</div>
            </div>
          </div>
        </div>
      </Link>
