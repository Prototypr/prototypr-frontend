...
const AccountNavigation = ({activeTab}) =>{
    return(
        ...
        <div className={"text-gray-700 "}>
          <div className={`${activeTab==1?"bg-blue-100 font-semibold text-blue-900":'hover:bg-blue-100/80'} flex justify-start p-2.5 px-4 rounded-xl text-sm cursor-pointer w-full`}>
        ...
        <div className={"text-gray-700"}>
        <div className={`${activeTab==2?"bg-blue-100 font-semibold text-blue-900":'hover:bg-blue-100/80'} flex justify-start p-2.5 px-4 rounded-xl text-sm cursor-pointer w-full`}>
            <div className="flex justify-start">
        ...
        <div className={"text-gray-700"}>
        <div className={`${activeTab==3?"bg-blue-100 font-semibold text-blue-900":'hover:bg-blue-100/80'} flex justify-start p-2.5 px-4 rounded-xl text-sm cursor-pointer w-full`}>
            <div className="flex justify-start">
            {/* <svg className="w-4 h-4 mr-3 my-auto"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M20 22H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1zm-1-2V4H5v16h14zM8 9h8v2H8V9zm0 4h8v2H8v-2z" fill="currentColor"/></svg> */}
        ...
        <div className={"text-gray-700"}>
        <div className={`${activeTab==4?"bg-blue-100 font-semibold text-blue-900":'hover:bg-blue-100/80'} flex justify-start p-2.5 px-4 rounded-xl text-sm cursor-pointer w-full`}>
            <div className="flex justify-start">
