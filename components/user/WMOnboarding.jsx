                ...
                <>
                  <div className="md:w-[585px] w-full px-10 lg:px-0 text-left">
                    ...
                    <p className="text-gray-600 mt-3">
                      ...
                      <span className="font-bold">inclusive</span> web for
                      designers and developers. Prototypr is a{" "}
                      <a
                        className="underline text-blue-600"
                        href="https://prototypr.io/post/announcing-prototypr-grant-for-the-web-flagship-project-%F0%9F%8E%89/"
                        target="_blank"
                      >
                        Grant for the Web
                      </a>{" "}
                      recipient piloting a new browser technology called '
                      <a
                        target="_blank"
                        className="text-blue-600 cursor-pointer underline"
                        href="https://prototypr.io/post/imagining-an-ad-free-internet-web-monetization-for-designers/"
                      >
                        Web Monetization
                      </a>
                    ...
                    <ul className="list-disc px-12 text-gray-600 my-6 text-left">
                      <li className="my-2">
                        ...
                        different ability and backgrounds.
                      </li>
                      <li className="my-2">
                        <span className="font-semibold">Earn recognition</span>:
                        A network to distribute your work, and make earnings
                ...
                <div className="md:w-[585px] w-full px-10 lg:px-0">
                  <div className="w-full p-8 text-center">
                    ...
                    <p className="text-gray-600 mt-3">
                      ...
                      <a
                        href="https://open.prototypr.io/web-monetization"
                        target="_blank"
                        className="underline text-blue-600"
                      >
                        Web Monetized
              ...
              render={({ next, previous }) => (
                <div className="md:w-[585px] w-full px-10 lg:px-0">
                  <div className="w-full p-8 text-center">
                    <img
                      className="mx-auto w-64 h-56  object-cover  mb-6 rounded-lg"
                      src="https://prototypr-media.sfo2.digitaloceanspaces.com/wp-content/uploads/2022/04/header.jpeg?format=webp&amp;w=1400"
                    ...
                    <p className="text-gray-600 mt-3">
                      Reach a global audience – the new Prototypr platform is
                      built to reach and support people of different abilities
                      and cultures.
                    </p>
                    <p className="text-gray-600 mt-3">
                      With a huge portion of design articles tailored to English
                      and Western culture,{" "}
                      <a
                        className="underline text-blue-600"
                        target="_blank"
                        href="https://open.prototypr.io/i18n"
                      >
                        internationalisation
                      </a>{" "}
                      is now built into the core of Prototypr, and we're
                      actively improving accessibility of the platform, so that
                      nobody's left out.
                    </p>
                  </div>
                  <div className="flex  px-8 justify-between">
              ...
              render={({ next, previous }) => (
                <div className="md:w-[585px] w-full px-10 lg:px-0">
                  <div className="w-full p-8 text-center">
                    <img
                      className="mx-auto w-64 h-56  object-cover  mb-6 rounded-lg"
                      src="https://prototyprio.gumlet.io/wp-content/uploads/2022/03/image1.jpg?format=webp&w=1400"
                    ...
                    <p className="text-gray-600 mt-3">
                      The code for the Prototypr platform will be published
                      under MIT Open License for anyone to remix, learn from,
                      and copy. Whether you're a designer, developer, writer, or
                      anything else, feel free to get in touch if you're
              ...
              render={({ previous }) => (
                <div className="md:w-[585px] w-full px-10 lg:px-0">
                  ...
                  <p className="text-gray-600 mb-3">
                    We believe in an open, inclusive web where information is
                    accessible and unburdened by paywalls or subscription fees,
                    whilst still rewarding authors.
                  </p>
                  <p className="text-gray-600 mb-3">
                  ...
                  <p className="text-gray-700 mt-3 mb-6">
                    We're in early, but as Web Monetisation grows, you’ll be at
                    the forefront of our platform and contributing to an open
                    web.
                  </p>
