  ...
  console.log(sponsor)
    return (
      <Container maxWidth='max-w-[984px] pt-28 px-6 lg:px-3'>
              ...
              <div className="flex mt-4 flex-col grid grid-cols-12 gap-2 md:gap-4 justify-end items-end">
            ...
            return  (
              <Link className="col-span-3 rounded-xl overflow-hidden" href={`/toolbox/${slug}`}>
              ...
              <a target="_blank" className="col-span-3 rounded-xl overflow-hidden" href={sponsor?.link?sponsor.link:`https://letter.so`}>
                <div className="h-[156px] w-full overflow-hidden relative rounded" >
