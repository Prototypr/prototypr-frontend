    ...
    <Dialog onOpenChange={toggleSubmitOpen} open={submitOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          className="text-base !rounded-full font-medium h-[44px] px-4 outline outline-blue-600 outline-1 py-0 mr-1 my-auto"
        >
          Submit for review
        </Button>
      </DialogTrigger>
      <DialogContentLarge variant="big">
        <div>
          ...
          <DialogDescription>
            <p className="mb-4">
              Your post will be submitted to our publication editors for
            ...
            <p className="mb-4">
              Readers will not see your post until it is
