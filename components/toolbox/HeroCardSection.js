        ...
        <div className="w-full z-10 grid grid-cols-12 lg:gap-8 flex pt-0 md:pt-6 p-6 lg:pb-16 justify-between ">
            ...
            <div className="flex flex-col justify-between">
              <div className="flex flex-col">
                <div className="flex flex-col">
                  ...
                  <div className="flex justify-between lg:hidden mt-4 flex-none">
                    ...
                    <div className="order-1 lg:hidden flex md:order-2 col-span-3 flex-col justify-end">
                      {!post?.attributes?.creators?.data?.length ? (
                        <div className="flex my-auto text-xs text-white">
                          <svg
          ...
          <div className="order-1 hidden lg:flex md:order-2 col-span-3 flex-col justify-end">
              ...
              <div className="flex text-xs text-white mb-4">
                ...
                <div className="inline-block my-auto">
                  <div className="flex">
                    ...
                    <div>
                      Claimed by{" "}
                      {post?.attributes?.creators?.data[0]?.attributes?.name}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="hidden md:flex gap-4 flex-none">
              ...
              {user?.id && user?.id == post?.attributes?.author?.data?.id ? (
                <div className="flex justify-end">
