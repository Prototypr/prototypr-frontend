...
const JobPostCard = ({ job }) => {
    ...
    <div className="flex-col p-6 shadow-sm group flex-grow h-full border-black/5 border-1 hover:shadow-lg transition-shadow duration-500 bg-white relative rounded-3xl">
        ...
        <div className="flex">
            {job.companyLogo?
            <div className="basis-[96px] my-auto pr-6">
              <div className="relative my-auto w-[96px] h-[96px] md:w-[96px] md:h-[96px] bg-[#CEE2FF] rounded-full border border-gray-100">
              {job.companyLogo?
              <Image
              loader={gumletLoader}
              priority={`false`}
            ...
            />:''}
              ...
              // <img className="w-[96px] h-[96px] md:w-[96px] md:h-[96px] bg-[#CEE2FF] rounded-full border border-gray-100" src={job.companyLogo}/>
              :<div className="w-[96px] h-[96px] bg-[#CEE2FF] rounded"></div>
            }
            {/* content */}
                <div className="flex flex-col">
                  <div className="flex mb-1">
                    <>
                    <h4 className="text-gray-800 mr-3 font-medium text-md">{job.companyName}</h4>
                    </>
                    <>
                   <TimeAgo
                  ...
                  <h1 className="line-clamp-1 text-xl m-0 mb-2 inter-font font-medium max-w-[400px]">{job.title}</h1>
                  <div className="flex">
