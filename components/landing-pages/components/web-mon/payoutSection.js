...
const PayoutSection = () => {
  return (
    <div className="w-full bg-white p-10">
      <div className="w-full max-w-7xl grid mx-auto py-0 md:py-32 flex flex-col grid gap-7 md:gap-4">
        <h3 className="md:text-[40px] text-[30px] text-gray-600 leading-[40px] md:leading-[50px]  font-semibold">
        ...
        <div className="w-full flex flex-col grid gap-5">
          <PayoutTable />
        </div>
      </div>
    </div>
