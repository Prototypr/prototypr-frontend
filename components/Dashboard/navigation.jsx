...
const Navigation = ({activeTab}) =>{
    return(
        ...
        <div className={"text-gray-700 mr-2"}>
          <div className={`${activeTab==1?"bg-gray-100 font-semibold text-royalblue-600 text-gray-900":'hover:bg-gray-50'} flex p-2.5 px-4 rounded-lg text-sm cursor-pointer w-full`}>
            <div className="flex">
        ...
        <div className={"text-gray-700 mr-2"}>
          <div className={`${activeTab==2?"bg-gray-100 font-semibold text-royalblue-600 text-gray-900":'hover:bg-gray-50'} flex p-2.5 px-4 rounded-lg text-sm cursor-pointer w-full`}>
            <div className="flex">
