...
const SignupHorizontal = dynamic(() => import("@/components/newsletter/SignupHorizontal"));
...
const PopoverDemo = () => {
  ...
  <Popover>
    <PopoverTrigger asChild>
      <button className="px-3 py-1.5 font-medium bg-blue-600 rounded rounded-md text-white hover:bg-blue-500">
          {buttonText}
    </button>
    </PopoverTrigger>
