...
export default function Navbar({ posts, type, activeNav }) {
    ...
    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            {/* <!-- Mobile menu button--> */}
            <button type="button" className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
        ...
        <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            <Link href="/" as="/">
                <div className="flex-shrink-0 flex items-center cursor-pointer">
                        <img className="block lg:hidden h-8 w-auto" src="https://prototypr.io/wp-content/uploads/2018/10/1_SdMNHdB-vvUH4eWMBYkzQw.png" alt="Workflow"/>
        ...
        <div className="hidden sm:block sm:ml-6">
            <div className="flex space-x-4">
                ...
                <a href="#" className={activeNav=='become-author'?"bg-gray-100 text-gray-900 px-3 py-2 rounded-md text-sm font-medium":"text-gray-800 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium"} aria-current="page">Become an author</a>
    ...
    <div className="sm:hidden" id="mobile-menu">
        ...
        {/* <!-- Current: "bg-gray-900 text-white", Default: "text-gray-800 hover:bg-gray-100 hover:text-gray-900" --> */}
        <a href="#" className={activeNav=='become-author'?"bg-gray-100 text-gray-900 block px-3 py-2 rounded-md text-base font-medium":"text-gray-800 hover:bg-gray-100 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium"} aria-current="page">Become an author</a>

        <a href="#" className={activeNav=='subscribe'?"bg-gray-100 text-gray-900 block px-3 py-2 rounded-md text-base font-medium":"text-gray-800 hover:bg-gray-100 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium"}>Subscribe</a>

        {/* <a href="#" className="text-gray-800 hover:bg-gray-100 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium">Projects</a>

        <a href="#" className="text-gray-800 hover:bg-gray-100 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium">Calendar</a> */}
        </div>
    </div>
    </nav>
