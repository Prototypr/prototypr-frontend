...
export default function Meta({ seo, articleJsonLd, productJsonLd }) {
  return (
    <>
      ...
      {typeof window &&<script type="text/javascript" async="async" dangerouslySetInnerHTML={{ __html: `window.GUMLET_CONFIG={srcset: true, hosts:[{current:"prototypr-media.sfo2.digitaloceanspaces.com",gumlet:"prototyprio.gumlet.io"}], lazy_load: true, auto_webp:true},d=document,s=d.createElement("script"),s.src="https://cdn.gumlet.com/gumlet.js/2.1/gumlet.min.js",s.async=1,d.getElementsByTagName("head")[0].appendChild(s);` }} />}
