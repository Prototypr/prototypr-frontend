        ...
        <section className="w-full">
            <div className="bg-white relative w-full h-100">
                ...
                <div className="absolute top-20 z-30 w-2/5" style={{left: "45%"}}>
                    ...
                    <p className="font-medium text-lg leading-normal">The Source tackles taboo topics, exposes unseen truths, and gets the scoop on the latest in the tech and design sphere.</p>
                    <div className="mt-7 relative h-16 w-10/12">
                        ...
                        <button className="absolute top-3 right-3 h-10 z-20 bg-blue-1 rounded-lg text-white text-base font-medium leading-6 flex items-center justify-center py-2 px-3 hover:opacity-70">Subscribe</button>
                    </div>
                </div>
            </div>
        </section>
