...
export default function ProductItem({post = {}}) {
  ...
  return (
    ...
    >
      <div className="w-36 h-36 rounded-lg bg-contain bg-no-repeat" style={{ backgroundImage: `url(${legacyFeaturedImage?.thumb})` }}></div>
      <div className="flex-1 ml-4">
        ...
        <div className="mt-3 flex items-center">
          <div className="w-9 h-9 rounded-full bg-100 bg-no-repeat bg-center" style={{backgroundImage: `url(${author?.data?.attributes?.avatar})`}}></div>
