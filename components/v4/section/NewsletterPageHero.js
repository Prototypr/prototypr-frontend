    ...
    return(
        <Container padding={padding} maxWidth="max-w-[1320px]">
            ...
            <div className="z-20 max-w-md xl:max-w-full">
                <h3 className="text-4xl tracking-tighter lg:text-5xl mb-10 leading-snug font-inter text-black/90 font-semibold">{title?title:<>
                    Weekly tools and stories to <br className="hidden xl:block"/> shape <div className="text-underline inline">every idea</div>
                </>}</h3>
                <SignupHomepage/>
                <p className="font-inter mb-4 mt-10 text-lg text-gray-900 text-opacity-80 max-w-xl">Join <span className="text-black/80 bg-indigo-200/70">25,000+ creatives</span> and receive our carefully curated digest of stories, tools and links, delivered to your inbox:</p>
