    ...
    return(
        <Container maxWidth="max-w-[1320px]">
            ...
            <div className="max-w-xl lg:max-w-xl">
                <h3 className="text-xl lg:text-3xl mb-2 font-inter text-white font-bold">The best design articles, every week</h3>
                <p className="font-inter mb-4 text-base leading-[24px] text-white text-opacity-80">Join 25,000+ creatives who enjoy a regular dose of inspiration and motivation, delivered to your inbox every Tuesday.</p>
                <SignupHomepage/>
            </div>
            <div>
            <img
