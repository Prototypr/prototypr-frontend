...
const TopicSpotlightSection = ({title='Featured topics', tagline, headingSize}) =>{
    return(
        <Container maxWidth="max-w-[1320px]" >
          <div className="bg-white rounded-lg shadow-sm p-6 md:p-10">
            <h2 className={`${headingSize?headingSize:'text-xl mb-6'} font-semibold`}>
              {title} 
            {/* {tagline?<span className="text-gray-500">{tagline}</span>:''} */}
            </h2>
