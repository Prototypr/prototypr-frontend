...
const NewsCard = ({link, title, image, tags, date, avatar, author, content, excerpt }) => {
  return (
    <div className="group mb-3 hover:scale-[1.01] hover:shadow-lg transition transition-all duration-400 bg-white row-span-1 shadow-sm border border-gray-300/50 p-3 flex flex-col-reverse sm:flex-row hover:bg-white transition transition-all duration-300 rounded-2xl  w-full justify-between">
